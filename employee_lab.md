...
#### Create a subclass of `Employee` called `Manager` in a package called staff.management.
...
#### Create a subclass of `Manager` called `Director` in the staff.management package.
